...
class CharDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        char = self.image_files[idx][0].upper()
...
def main(PLACA = 'br',EPOCHS = 15):
    ...
    train_dataset = CharDataset(root_dir=f'datasets/dataset_chars/train/{PLACA}/letras', transform=transform)
    val_dataset = CharDataset(root_dir=f'datasets/dataset_chars/val/{PLACA}/letras', transform=transform)
    ...
    torch.save(model.state_dict(), f'charmodels/{PLACA}-letras.pth')
    ...
    plt.legend()
    plt.savefig(f'train_results/{PLACA}-letras.png')
